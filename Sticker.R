...
Sticker <- sticker(Plot, package = "", p_fontface = "bold", h_color = "wheat1", h_fill = "snow", p_family = "sans", p_color = "black", p_size = 25, s_x = 1, s_y = 1.095, s_width = 1.9, s_height = 1.3, filename = "figures/Sticker.png")